              ...
              Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      ),Spacer(),Text(AppStrings.seeMore,style:Theme.of(context).textTheme.labelMedium ,),
                      SizedBox(width: AppSize.s4,), Icon(Icons.arrow_forward_ios,size:AppSize.s16 ,color: ColorManager.white,)
                        ...
                        return Stack(
                          children: [
                            CachedNetworkImage(width:97,height: 120 ,fit: BoxFit.cover,
                              imageUrl: ApiConstants.imageUrl(cubit.topRatedMovies[index].backdropPath),
